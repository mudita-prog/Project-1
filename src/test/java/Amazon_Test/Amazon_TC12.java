...
public class Amazon_TC12 extends _Launch_Quit {
	
@Test
	
	public void TestingEachPaymentMethod() throws InterruptedException, IOException
   ...
   cp.Select_Card();
   Thread.sleep(500);
   cp.Card_Payment(driver);
   cp.Select_EMI();
   
   Reporter.log("TestCase12 is passed");
}
	}
